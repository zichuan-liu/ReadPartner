...
//        }
    ...
    public TaskDialog setOnClickBottomListener(OnClickBottomListener onClickBottomListener) {
    ...
    public TaskDialog setMessage(String message) {
    ...
    public TaskDialog setPositive(String positive) {
    ...
    public TaskDialog setNegtive(String negtive) {
...
//    }
    ...
    public TaskDialog setSingle(boolean single) {
        isSingle = single;
        return this ;
    }
